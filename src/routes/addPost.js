    ...
    <React.Fragment>
      ...
      <form className="add-form" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select
            name="makers"
            onChange={(ev) => setMaker(ev.target.value)}
            required
          >
        ...
        <div>
          ...
          <div className="form-sections">
            ...
            <input
              ...
              value={modelCode}
              onChange={(ev) => setModelCode(ev.target.value)}
              required
            ></input>
          </div>
        </div>
        <div>
          ...
          <div className="form-sections">
            <input
              ...
              value={engineCode}
              onChange={(ev) => setEngineCode(ev.target.value)}
              required
            ></input>
            <input
              type="number"
              ...
              onChange={(ev) => setEngineDisplacement(ev.target.value)}
              required
            ></input>
            <input
              type="number"
              ...
              value={engineHP}
              onChange={(ev) => setEngineHP(ev.target.value)}
              required
            ></input>
            <input
              type="number"
              ...
              placeholder="torque"
              value={engineTorque}
              onChange={(ev) => setEngineTorque(ev.target.value)}
              required
            ></input>
            <input
              type="number"
              ...
              value={cylinders}
              onChange={(ev) => setCylinders(ev.target.value)}
              required
            ></input>
            <select
              name="configuration"
              ...
              onChange={(ev) => setEngineConfiguration(ev.target.value)}
              required
            >
